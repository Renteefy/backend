...
const getAllUsers = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const users = yield user_service_1.listUsers({ User: user_model_1.default });
    res.send(users);
});
...
const storeLoginDetails = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const isUserCreated = yield user_service_1.createUser({
...
const patchUserInfo = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userID = res.locals.jwtPayload["userID"];
        const isUpdated = yield user_service_1.updateUserInfo({
            User: user_model_1.default,
            userID: userID,
